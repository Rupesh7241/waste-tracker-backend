...
const io = new Server(server, {
  cors: {
    origin: [
      'http://localhost:5173',
      'http://localhost:4173',
      'waste-tracker-frontend-f6c2fistf-rupesh7241s-projects.vercel.app',    
...
app.use(cors({
  origin: [
    'http://localhost:5173',
    'http://localhost:4173',
    'waste-tracker-frontend-f6c2fistf-rupesh7241s-projects.vercel.app',        // ← your Vercel URL (add after step 3)
    process.env.FRONTEND_URL,
  ],
  credentials: true,
}));
